...
5. DOS BANDOLERAS BLANCAS cruzadas en X sobre el pecho (NO una sola diagonal): una va del hombro derecho a la cadera izquierda, la otra del hombro izquierdo a la cadera derecha, formando una equis blanca sobre el azul.
...
9. SHAKO/MORRIÓN NEGRO ALTO CILÍNDRICO en la cabeza, derecho como un cilindro, con la COPA SUPERIOR ROJA bien visible arriba y una banda/borde negro abajo. NO es galera baja, NO es bicornio, NO es tricornio: es un sombrero militar alto cilíndrico.
10. PLUMA/PENACHO BLANCO ALTO y vertical, saliendo del frente del shako, casi tan alto como el shako mismo.
